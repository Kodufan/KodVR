...
namespace StarterAssets
{
    public partial class StarterAssetsDeployMenu : ScriptableObject
    {
        ...
        {
            var firstPersonControllers = FindObjectsOfType<CharacterController>();
            ...
            if (player == null)
            {
                if (TryLocatePrefab(PlayerCapsulePrefabName, null, new []{typeof(CharacterController)}, out GameObject prefab, out string _))
                {
        ...
        {
            if (TryLocatePrefab(PlayerCapsulePrefabName, null, new[] { typeof(CharacterController), typeof(StarterAssetsInputs) }, out GameObject _, out string prefabPath))
            {
